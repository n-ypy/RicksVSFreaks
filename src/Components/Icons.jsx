export const FighterIcon = ({ className }) => (
...
export const HealerIcon = ({ className }) => (
...
export const DamageIcon = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <path
...
export const HealIcon = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 122.88">
        <path
...
export const DeadIcon = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
...
export const PassiveAbilityIcon = ({ className }) => (
...
export const ActiveAbilityIcon = ({ className }) => (
...
export const CooldownIcon = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
